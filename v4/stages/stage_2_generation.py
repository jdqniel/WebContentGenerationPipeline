...
class GenerationStage(BaseStage):
    ...
    async def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 5. Consolidate results into the state
        ...
        state['usage_statistics'] = {
            "prompt_tokens": pt_1 + pt_2 + pt_3 + pt_4 + pt_5,
            "completion_tokens": ct_1 + ct_2 + ct_3 + ct_4 + ct_5,
            "total_tokens": (
                pt_1 + ct_1 + pt_2 + ct_2 + pt_3 + ct_3 + pt_4 + ct_4 + pt_5 + ct_5
            ),
        }
